...
const PROVIDERS = [
  ...
  },
  {
    ...
    models: [
      { id: "google/gemini-2.0-flash-exp:free", label: "Gemini 2.0 Flash ⚡ FREE (no credits needed)" },
      ...
      { id: "google/gemini-2.5-flash-preview", label: "Gemini 2.5 Flash (paid, fast)" },
      ...
      { id: "anthropic/claude-3-5-sonnet", label: "Claude 3.5 Sonnet (paid, via OpenRouter)" },
    ],
  },
  {
    id: "openai" as const,
