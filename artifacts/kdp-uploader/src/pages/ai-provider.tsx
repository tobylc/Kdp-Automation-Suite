...
const PROVIDERS = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: "meta-llama/llama-3.2-90b-vision-instruct", label: "Llama 3.2 90B Vision (free tier)" },
      { id: "openai/gpt-4o-mini", label: "GPT-4o mini (cheap, vision)" },
      { id: "openai/gpt-4o", label: "GPT-4o (premium, vision)" },
