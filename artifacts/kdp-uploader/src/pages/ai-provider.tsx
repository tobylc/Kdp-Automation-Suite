...
const PROVIDERS = [
  ...
  },
  {
    ...
    models: [
      ...
      // ── Google Gemini ───────────────────────────────────────────────────
      { id: "google/gemini-2.5-flash-lite",            label: "Google: Gemini 2.5 Flash Lite — ~$0.10/M, vision ✓" },
      { id: "google/gemini-2.5-flash",                 label: "Google: Gemini 2.5 Flash — ~$0.30/M, vision ✓" },
      { id: "google/gemini-2.5-pro",                   label: "Google: Gemini 2.5 Pro — ~$1.25/M, best Google vision" },
      { id: "google/gemini-3.1-pro-preview-custom-tools", label: "Google: Gemini 3.1 Pro Preview — vision" },
      // ── OpenAI GPT-4 series ─────────────────────────────────────────────
      { id: "openai/chatgpt-4o-latest",                label: "OpenAI: GPT Chat Latest — vision" },
      { id: "openai/gpt-4o",                           label: "OpenAI: GPT-4o — ~$2.50/M, vision ✓" },
      { id: "openai/gpt-4o-2024-11-20",                label: "OpenAI: GPT-4o (2024-11-20) — vision" },
      { id: "openai/gpt-4o-mini",                      label: "OpenAI: GPT-4o mini — ~$0.15/M, vision" },
      { id: "openai/gpt-4o-mini-2024-07-18",           label: "OpenAI: GPT-4o mini (2024-07-18) — vision" },
      { id: "openai/gpt-4.1",                          label: "OpenAI: GPT-4.1 — ~$2/M, vision" },
      { id: "openai/gpt-4.1-mini",                     label: "OpenAI: GPT-4.1 mini — ~$0.40/M, vision" },
      { id: "openai/gpt-4-turbo",                      label: "OpenAI: GPT-4 Turbo — vision" },
      { id: "openai/gpt-4-turbo-preview",              label: "OpenAI: GPT-4 Turbo Preview — vision" },
      { id: "openai/gpt-4o-search-preview",            label: "OpenAI: GPT-4o Search Preview — vision" },
      { id: "openai/gpt-4o-mini-search-preview",       label: "OpenAI: GPT-4o mini Search Preview — vision" },
      { id: "openai/gpt-3.5-turbo",                    label: "OpenAI: GPT-3.5 Turbo — text only" },
      // ── OpenAI o-series ─────────────────────────────────────────────────
      { id: "openai/o1",                               label: "OpenAI: o1 — reasoning + vision" },
      { id: "openai/o1-pro",                           label: "OpenAI: o1 Pro — reasoning + vision" },
      { id: "openai/o3-mini",                          label: "OpenAI: o3 Mini — reasoning" },
      { id: "openai/o3-mini-high",                     label: "OpenAI: o3 Mini High — reasoning" },
      { id: "openai/o3",                               label: "OpenAI: o3 — reasoning + vision" },
      { id: "openai/o3-pro",                           label: "OpenAI: o3 Pro — reasoning + vision" },
      { id: "openai/o4-mini",                          label: "OpenAI: o4 Mini — reasoning + vision" },
      { id: "openai/o4-mini-high",                     label: "OpenAI: o4 Mini High — reasoning + vision" },
      // ── Meta Llama ──────────────────────────────────────────────────────
      ...
      // ── Qwen vision ─────────────────────────────────────────────────────
      { id: "qwen/qwen3-vl-32b-instruct",              label: "Qwen: Qwen3 VL 32B Instruct — vision" },
      { id: "qwen/qwen3-vl-8b-thinking",               label: "Qwen: Qwen3 VL 8B Thinking — vision" },
      { id: "qwen/qwen3-max",                          label: "Qwen: Qwen3 Max — text+reasoning" },
      { id: "qwen/qwen3-max-thinking",                 label: "Qwen: Qwen3 Max Thinking — reasoning" },
      { id: "qwen/qwen3-235b-a22b",                    label: "Qwen: Qwen3 235B A22B — large text" },
      { id: "qwen/qwen3.7-plus",                       label: "Qwen: Qwen3.7 Plus — text+reasoning" },
      { id: "qwen/qwen3.7-max",                        label: "Qwen: Qwen3.7 Max — text+reasoning" },
      { id: "qwen/qwen3.6-flash",                      label: "Qwen: Qwen3.6 Flash — fast text" },
      { id: "qwen/qwen3.6-plus",                       label: "Qwen: Qwen3.6 Plus — text" },
      // ── Anthropic via OpenRouter ─────────────────────────────────────────
      { id: "anthropic/claude-3-haiku",                label: "Anthropic: Claude 3 Haiku — ~$0.25/M" },
      { id: "anthropic/claude-3.5-haiku",              label: "Anthropic: Claude 3.5 Haiku — ~$0.80/M" },
      { id: "anthropic/claude-3.5-sonnet",             label: "Anthropic: Claude 3.5 Sonnet — ~$3/M, vision" },
      { id: "anthropic/claude-sonnet-4-5",             label: "Anthropic: Claude Sonnet 4.5 — ~$3/M, vision" },
      { id: "anthropic/claude-opus-4-6",               label: "Anthropic: Claude Opus 4.6 Fast — premium vision" },
      { id: "anthropic/claude-opus-4-7",               label: "Anthropic: Claude Opus 4.7 Fast — premium vision" },
      { id: "anthropic/claude-opus-4-8",               label: "Anthropic: Claude Opus 4.8 Fast — premium vision" },
      // ── xAI Grok ────────────────────────────────────────────────────────
      { id: "x-ai/grok-build-0.1",                     label: "xAI: Grok Build 0.1" },
      { id: "x-ai/grok-4-3",                           label: "xAI: Grok 4.3 — vision" },
      { id: "x-ai/grok-4-20",                          label: "xAI: Grok 4.20 — vision" },
      { id: "x-ai/grok-4-20-multi-agent",              label: "xAI: Grok 4.20 Multi-Agent — vision" },
      // ── MiniMax ─────────────────────────────────────────────────────────
      { id: "minimax/minimax-01",                      label: "MiniMax: MiniMax-01 — text" },
    ],
  },
  {
    id: "openai" as const,
