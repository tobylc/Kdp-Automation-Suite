...
const PROVIDERS = [
  ...
  },
  {
    ...
    models: [
      { id: "qwen/qwen2.5-vl-72b-instruct:free", label: "Qwen 2.5 VL 72B FREE ⚡ (best free vision model)" },
      { id: "qwen/qwen2.5-vl-32b-instruct:free", label: "Qwen 2.5 VL 32B FREE (fast free vision)" },
      { id: "meta-llama/llama-3.2-11b-vision-instruct:free", label: "Llama 3.2 11B Vision FREE (reliable free)" },
      { id: "mistralai/mistral-small-3.1-24b-instruct:free", label: "Mistral Small 3.1 24B FREE (vision + text)" },
      { id: "google/gemini-2.5-flash", label: "Gemini 2.5 Flash (paid, fast + excellent vision)" },
      { id: "openai/gpt-4o-mini", label: "GPT-4o mini (paid, affordable vision)" },
      { id: "openai/gpt-4o", label: "GPT-4o (paid, premium vision)" },
      { id: "anthropic/claude-3.5-haiku", label: "Claude 3.5 Haiku (paid, cheap + reliable)" },
      { id: "anthropic/claude-3.5-sonnet", label: "Claude 3.5 Sonnet (paid, best fallback)" },
    ],
  },
  {
    id: "openai" as const,
