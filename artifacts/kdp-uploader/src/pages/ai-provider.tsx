...
const PROVIDERS = [
  ...
  },
  {
    ...
    models: [
      { id: "qwen/qwen2.5-vl-72b-instruct", label: "Qwen 2.5 VL 72B ⚡ (best vision value, ~$0.30/M)" },
      { id: "qwen/qwen2.5-vl-32b-instruct", label: "Qwen 2.5 VL 32B (fast vision, ~$0.10/M)" },
      { id: "google/gemini-2.5-flash", label: "Gemini 2.5 Flash (excellent vision, ~$0.15/M)" },
      { id: "google/gemini-2.5-pro", label: "Gemini 2.5 Pro (best Google vision, ~$1.25/M)" },
      { id: "openai/gpt-4o-mini", label: "GPT-4o mini (affordable vision, ~$0.15/M)" },
      { id: "openai/gpt-4o", label: "GPT-4o (premium vision, ~$2.50/M)" },
      { id: "anthropic/claude-3.5-haiku", label: "Claude 3.5 Haiku (cheap + reliable, ~$0.80/M)" },
      { id: "anthropic/claude-3.5-sonnet", label: "Claude 3.5 Sonnet (best fallback, ~$3/M)" },
    ],
  },
  {
    id: "openai" as const,
