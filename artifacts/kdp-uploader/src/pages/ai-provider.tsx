...
const PROVIDERS = [
  ...
  },
  {
    ...
    models: [
      { id: "google/gemini-2.0-flash-exp:free", label: "Gemini 2.0 Flash FREE ⚡ (no credits needed, vision)" },
      { id: "meta-llama/llama-3.2-11b-vision-instruct:free", label: "Llama 3.2 11B Vision FREE (no credits needed)" },
      { id: "meta-llama/llama-3.2-90b-vision-instruct:free", label: "Llama 3.2 90B Vision FREE (no credits needed)" },
      { id: "google/gemini-2.0-flash-exp", label: "Gemini 2.0 Flash (paid credits, faster limits)" },
      { id: "google/gemini-2.5-flash-preview:thinking", label: "Gemini 2.5 Flash (paid, best Google vision)" },
      { id: "openai/gpt-4o-mini", label: "GPT-4o mini (paid, vision)" },
      { id: "openai/gpt-4o", label: "GPT-4o (paid, premium vision)" },
      { id: "anthropic/claude-3-5-sonnet", label: "Claude 3.5 Sonnet (paid, reliable fallback)" },
      { id: "anthropic/claude-3-7-sonnet", label: "Claude 3.7 Sonnet (paid, latest)" },
    ],
  },
  {
    id: "openai" as const,
